...
void selectionSort(vector<Bid>& bids) {
    ...
    for (size_t pos = 0; pos < size - 1; ++pos) {
        ...
        for (size_t pos2 = pos + 1; pos2 < size; ++pos2) {
            // if this element's title is less than minimum title
            if (bids.at(pos2).title.compare(bids.at(min).title) < 0) {
...
int main(int argc, char* argv[]) {
    ...
    case 2:
        ...
        break;
    default: 
        // csvPath variable left commented out for quick debugging instead
        // of executing with command prompt with args.
    ...
    while (choice != 9) {
        ...
        case 3:
            // Initialize a timer variable before selection sorting
            ticks = clock();

            // call to selectionSort function and pass bids vector
            selectionSort(bids);
        ...
        case 4:
            // Initialize a timer variable before quick sorting
            ticks = clock();

            // call to quickSort function with bids vector, begging, and end ints
